...
function Home() {
  ...
  useEffect(() => {
    // Show the auth prompt after a short delay when the component mounts
    ...
    <>
      ...
      <div className="flex flex-wrap xl:flex-nowrap">
        <div className="w-full xl:max-w-[600px]">
          <img className="w-full h-full" src={Banner || "/placeholder.svg"} alt="" />
        </div>
          ...
          <div className="border-t border-gray-200 px-4 py-5 sm:p-6">
            <div className="prose max-w-3xl text-gray-500">
              ...
              <p>
                ...
                zamonaviy sun'iy intellektdan foydalanadi. Shunchaki tibbiy tasviringizni yuklang, va bizning tizimimiz
                uni qayta ishlab, mumkin bo'lgan holatlarni ishonch foizlari bilan aniqlaydi.
              </p>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  <strong>KT skanerlari</strong> - Turli holatlar uchun kompyuter tomografiyasi tasvirlarini tahlil
                  qilish
                </li>
                <li>
                  <strong>MRT skanerlari</strong> - To'qimalarni batafsil tahlil qilish uchun magnit-rezonans
                ...
                <li>
                  <strong>Boshqa tibbiy tasvirlar</strong> - Qo'shimcha maxsus tasvirlash turlari uchun
                  qo'llab-quvvatlash
                </li>
              </ul>
            </div>
